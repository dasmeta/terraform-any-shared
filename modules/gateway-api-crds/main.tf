...
data "kubectl_file_documents" "gateway_api_crds" {
  content = file("${path.module}/files/${var.configs.version}-standard-install.yaml") # the file pulled from url "https://github.com/kubernetes-sigs/gateway-api/releases/download/${var.crd_version}/standard-install.yaml"
}
